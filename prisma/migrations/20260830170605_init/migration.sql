...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AUDIOBOOK', 'CONVERSATIONAL', 'CUSTOMER_SERVICE', 'GENERAL', 'NARRATIVE', 'CHARACTERS', 'MEDITATION', 'MOTIVATIONAL', 'PODCAST', 'CORPORATE');
...
CREATE TABLE "Voice" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "catergory" "VoiceCategory" NOT NULL DEFAULT 'GENERAL',
